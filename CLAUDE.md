...
score integer [not null, default: 100, note: '강사등급을 위한 점수. 강사 섭외 자동배정 순위에 사용']
created_at timestamp [not null, default: `now()`]
mentor_unique_code varchar [not null, unique, note: '강사 고유 코드. 영문+숫자 랜덤 5자리(혼동되는 0/O/1/I/L 제외), 트리거로 자동발급(수동 수정 불가)']
identity_verified_at timestamptz [note: 'PortOne 실명 본인인증 완료 시각']
identity_verification_ci varchar [unique, note: '본인인증 연계정보(CI). 동일인 중복가입 방지용']
}
...
school_request_note text [note: '이 강사에게만 해당하는 학교요청사항']
...
memo text [note : '메모']
school_request_note text [note: '행사 전체에 공통으로 적용되는 학교요청사항']
contact_name varchar [note: '담당자 이름']
contact_email varchar [note: '담당자 이메일']
contact_phone varchar [note: '담당자 연락처']
