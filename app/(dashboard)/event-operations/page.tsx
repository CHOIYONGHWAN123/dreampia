  ...
  for (const e of events) {
    ...
    for (const date of dates) {
      rows.push({
        ...
        suppliesAdminId: e.supplies_admin_id,
        suppliesAdminName: e.supplies_admin_id ? (adminMap.get(e.supplies_admin_id) ?? null) : null,
