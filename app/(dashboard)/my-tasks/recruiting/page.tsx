...
export default async function RecruitingPage() {
  ...
  // 영업담당자, 소통담당자 또는 강사담당자로 지정된, 아직 섭외가 끝나지 않은(대기/진행중) 행사만 표시.
  // 슈퍼관리자는 담당자 여부와 무관하게 전체 조회.
  let eventsQuery = supabase
    .from('events')
    .select('id, institution_id, sales_admin_id, comm_admin_id, recruit_admin_id, event_start_at, event_end_at, recruit_status')
