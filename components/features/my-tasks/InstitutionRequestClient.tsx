  ...
  return (
    <div className="p-8">
      <div className="flex items-center justify-between pb-4 border-b border-gray-200 mb-6">
        <h1 className="text-2xl font-bold text-gray-900">기관 요청사항 전달</h1>
      </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-amber-50 border-b border-gray-200">
              ...
              <th className="px-4 py-2.5 text-center font-medium text-gray-700 w-32">기관 요청사항 다운</th>
              <th className="px-4 py-2.5 text-center font-medium text-gray-700 w-32">기관요청사항 전달</th>
            </tr>
          </thead>
          <tbody>
            {rows.length > 0 ? (
                ...
                <tr key={row.id} className="border-b border-gray-100 last:border-b-0 hover:bg-gray-50">
                  ...
                  <td className="px-4 py-2.5 text-center">
                    <a
                      ...
                      className="px-3 py-1 text-xs bg-white border border-gray-300 text-gray-700 rounded hover:bg-gray-50 transition-colors whitespace-nowrap inline-block"
                    >
                      다운
                    </a>
                  </td>
