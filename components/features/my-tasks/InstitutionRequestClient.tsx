        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-primary-50 border-b border-primary-100">
              ...
              <th className="px-4 py-2.5 text-center font-bold text-primary-700 w-32">기관 요청사항 다운</th>
              <th className="px-4 py-2.5 text-center font-bold text-primary-700 w-32">기관요청사항 전달</th>
            </tr>
          </thead>
          <tbody>
            {rows.length > 0 ? (
